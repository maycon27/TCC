...
public class CodeIntegerEnumType implements DynamicParameterizedType, UserType {
    ...
    public Object nullSafeGet(ResultSet resultSet, String[] names, SharedSessionContractImplementor sharedSessionContractImplementor, Object o) throws HibernateException, SQLException {
        Integer label = resultSet.getInt(names[0]);
        ...
        for (Enum value : returnedClass().getEnumConstants()) {
            if (value instanceof CodeIntegerEnum) {
                CodeIntegerEnum codeIntegerEnum = (CodeIntegerEnum) value;
                if (codeIntegerEnum.getCode().equals(label)) {
                    return value;
                }
            }
        }
    ...
    public void nullSafeSet(PreparedStatement preparedStatement, Object value, int index, SharedSessionContractImplementor sharedSessionContractImplementor) throws HibernateException, SQLException {
        if (value == null) {
            ...
            preparedStatement.setInt(index, ((CodeIntegerEnum) value).getCode());
        }
    }

...
import com.tcc.doman.exception.BusinessException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request) {
		...
		ProblemType problemType = ProblemType.DADOS_INVALIDOS;
		String detail = getMensagemErro(ex);
	...
	protected ResponseEntity<Object> handleEntityNotFound(
		...
		var erroId = ex.getCause() instanceof javax.persistence.EntityNotFoundException;

		HttpStatus status = erroId
				? HttpStatus.CONFLICT
				: HttpStatus.INTERNAL_SERVER_ERROR;


		ProblemType problemType = erroId
				? ProblemType.ID_INVALIDO
	...
	protected ResponseEntity<Object> handleInvalidDataAccessApiUsageExceptio(
			InvalidDataAccessApiUsageException ex, WebRequest request) {

		var erroId = ex.getCause() instanceof PersistentObjectException;
